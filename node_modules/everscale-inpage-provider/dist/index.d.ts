...
export declare class ProviderRpcClient {
     ...
     * Required permissions: `basic`
     */
    computeStorageFee(args: ProviderApiRequestParams<'computeStorageFee'>): Promise<ProviderApiResponse<'computeStorageFee'>>;
    /**
 ...
 * @category Provider
 */
export type RawRpcMethod<P extends ProviderMethod> = RawProviderApiRequestParams<P> extends undefined ? () => Promise<RawProviderApiResponse<P>> : (args: RawProviderApiRequestParams<P>) => Promise<RawProviderApiResponse<P>>;
/**
 * @category Provider
 */
 ...
 * @category Provider
 */
export type GetExpectedAddressParams<Abi> = Abi extends {
    data: infer D;
} ? {
    /**
