...
exports.copyExternalArtifacts = exports.typeGenerator = void 0;
const fs_1 = __importDefault(require("fs"));
const fsPath = __importStar(require("path"));
const utils_1 = require("../utils");
const typeGenerator = (pathToBuildFolder, ...additionalFiles) => {
    const generatedCode = [...getAbiFiles(pathToBuildFolder)]
        .map(file => getContractAbi(pathToBuildFolder, file))
        .concat(additionalFiles.map(el => {
        return {
            abi: fs_1.default.readFileSync(el, "utf8"),
            name: (0, utils_1.getContractNameFromAbiPath)(el),
        };
    }))
        .map(({ abi, name }) => ({
        contractName: name,
...
const copyExternalArtifacts = (externalContracts, destinationFolder) => {
