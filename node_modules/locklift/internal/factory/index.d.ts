...
export declare class Factory<T extends FactoryType> {
    ...
    private constructor();
    static setup<T extends FactoryType>(ever: ProviderRpcClient, giver: () => Giver, accountsStorage: SimpleAccountsStorage, preloadedAccounts?: Array<{
    ...
    getContractByCodeHash: (codeHash: string | undefined, address: Address) => ContractWithArtifacts | undefined;
    getContractByCodeHashOrDefault: (codeHash: string, address: Address) => ContractWithArtifacts;
