...
class Factory {
    constructor(ever, giver, accountsStorage) {
        ...
        this.giver = giver;
        this.factoryCache = {};
        this.deployContract = async (args) => {
        ...
        this.getDeployedContract = (name, address) => {
            return new this.ever.Contract(this.getContractArtifacts(name)?.abi, address);
        };
        this.initializeContract = async (name, resolvedPath) => {
        ...
        this.getContractArtifacts = (name) => {
        ...
        this.getContractByCodeHash = (codeHash, address) => {
        ...
        this.getContractByCodeHashOrDefault = (codeHash, address) => {
